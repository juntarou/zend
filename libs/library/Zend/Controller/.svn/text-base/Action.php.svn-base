...
//require_once 'Zend/ViewSmarty.php';
/**
 * @category   Zend
 * @package    Zend_Controller
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
...
abstract class Zend_Controller_Action implements Zend_Controller_Action_Interface
{
	...
	$this->_config = new Zend_Config_Ini(APP_CONFIG_DIR_PATH . APP_CONFIGS_FILE_NAME, "production");
        $this->init();
    }
	...
	$this->_config->smarty->templatesDir,
	    array(
		'compile_dir' => $this->_config->smarty->compileDir,
		'config_dir'  => $this->_config->smarty->configsDir,
		'cache_dir'   => $this->_config->smarty->cacheDir,
	    )
	);
    ...
    {
	//$this->view->_smarty->get_config_vars();
    }
